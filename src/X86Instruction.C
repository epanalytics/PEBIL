...
void X86InstructionClassifier::generateTable(){
    ...
    mkclass(        pmovsxbd, simdMove,       0,   0,  128,    0,         32)
    mkclass(        pmovsxbq, simdMove,       0,   0,  128,    0,         64)
    mkclass(        pmovsxbw, simdMove,       0,   0,  128,    0,         16)
    mkclass(        pmovsxdq, simdMove,       0,   0,  128,    0,         64)
    mkclass(        pmovsxwd, simdMove,       0,   0,  128,    0,         32)
    mkclass(        pmovsxwq, simdMove,       0,   0,  128,    0,         64)
    mkclass(        pmovzxbd, simdMove,       0,   0,  128,    0,         32)
    mkclass(        pmovzxbq, simdMove,       0,   0,  128,    0,         64)
    mkclass(        pmovzxbw, simdMove,       0,   0,  128,    0,         16)
    mkclass(        pmovzxdq, simdMove,       0,   0,  128,    0,         64)
    mkclass(        pmovzxwd, simdMove,       0,   0,  128,    0,         32)
    mkclass(        pmovzxwq, simdMove,       0,   0,  128,    0,         64)
...
//    mkclass(      vbroadcast,      move,        0,    0,    0,    0,     0)
    ...
    mkclass(      vpmaskmovd,    simdInt,    intv,    0,    VRSZ,    0,    32)
    mkclass(      vpmaskmovq,    simdInt,    intv,    0,    VRSZ,    0,    64)
